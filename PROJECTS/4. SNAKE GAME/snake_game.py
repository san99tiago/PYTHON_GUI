...
class Snake( tk.Canvas ):
    ...
    def load_images(self):
        ...
        try:
            ...
            #Open the image of the body of the snake and the food
            self.snake_body_image = Image.open( os.path.join(current_folder, "imgs", "snake.png") )
            self.food_image = Image.open( os.path.join(current_folder, "imgs", "food.png"))
            #Create the "PhotoImage" with the opened image before
    ...
    def end_game(self):
        ...
        self.rick_image = Image.open( current_folder + "\\imgs\\rick.png")
