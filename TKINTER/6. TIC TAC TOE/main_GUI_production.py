# MAIN GUI FOR TIC TAC TOE GAME (FOR PRODUCTION WITH PYINSTALLER)
...
class TicTacToeGUI(tk.Canvas):
    ...
    def load_images(self):
        ...
        try:
            ...
            self.player_2_img = Image.open(os.path.join(bundle_dir, "imgs", "player_2.png"))
            self.robot_img = Image.open(os.path.join(bundle_dir, "imgs", "robot.png"))
...
if __name__ == "__main__":
    # FOR PRODUCTION: better to add try-except at the executing of the window
    try:
        ...
        # This is how we look for the problem, if something happened in...
        # ...the executable in production (with py-installer)
        import traceback
        traceback.print_exc()
